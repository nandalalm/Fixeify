...
const FixeifyProForm = () => {
    ...
    setFormData((prev) => {
      const newValue =
        field === "profilePhoto"
          ...
          : {
            idProof: prev.idProof.filter((file) => file !== fileToRemove),
            idProofUrls: prev.idProofUrls.slice(0, -1),
          };
  ...
  const handleCategoryChange = (categoryId: string) => {
    setFormData((prev) => ({ ...prev, categoryId, customService: categoryId === "other" ? prev.customService : "" }));
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2 mt-1">
                  ...
                  <button
                    ...
                    className={`px-3 py-1 rounded-md ${formData.categoryId === "other"
                        ? "bg-[#032B44] text-white dark:!text-white"
                        : "bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-300"
                      } hover:bg-[#054869] hover:text-white transition-colors`}
                  >
